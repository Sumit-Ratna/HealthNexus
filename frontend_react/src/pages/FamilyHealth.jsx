...
const FamilyHealth = () => {
    ...
    const handleInitiate = async (e) => {
        ...
        try {
            ...
            console.log(`✅ [FAKE OTP] Code for Family Add: ${fakeOtp}`);
            alert(`[DEV MODE] Family Add OTP is: ${fakeOtp}`);

            // 3. Mock Confirmation Result
            ...
            let errMsg = err.response?.data?.error || err.message || 'Failed to send OTP';
            setError(errMsg);
        } finally {
            setLoading(false);
        }
