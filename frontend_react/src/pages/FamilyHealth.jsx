...
const FamilyHealth = () => {
    ...
    const fetchFamilyMembers = async () => {
        try {
            ...
            const res = await axios.get('http://localhost:8000/api/family/list', {
    ...
    const handleInitiate = async (e) => {
        ...
        try {
            ...
            const token = localStorage.getItem('accessToken');
            await axios.post('http://localhost:8000/api/family/add', {
    ...
    const handleVerify = async (e) => {
        ...
        try {
            ...
            const token = localStorage.getItem('accessToken');
            await axios.post('http://localhost:8000/api/family/verify', {
                phone: newMemberPhone,
    ...
    const handleRemoveMember = async (memberId) => {
        ...
        try {
            const token = localStorage.getItem('accessToken');
            await axios.delete(`http://localhost:8000/api/family/${memberId}`, {
                headers: { Authorization: `Bearer ${token}` }
            });
            fetchFamilyMembers();
        } catch (err) {
